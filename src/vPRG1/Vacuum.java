...
class Vacuum {
    public static void main(String[] args) {
        ...
        while (surfaceIsDirty && hasBattery) {
            ...
            cleanWorld(surface, vacuumPosition, bag);
            battery--;
    ...
    static void cleanWorld(int[][] surface, int[] vacuumPosition, int[] bag) {
    ...
    static void printWorld(int[][] aMap, int[] vacuumPosition, int battery, int[] bag) {
        ...
        System.out.println("---".repeat(aMap[0].length));
        System.out.println("Batería: " + battery + " | Bolsa: " + bag[0] + "/" + bag[1]);
    }
